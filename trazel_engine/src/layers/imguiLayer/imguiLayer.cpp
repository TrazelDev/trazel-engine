...
VkAllocationCallbacks*   imguiLayer::g_Allocator = NULL;
VkInstance               imguiLayer::g_Instance = VK_NULL_HANDLE;
VkPhysicalDevice         imguiLayer::g_PhysicalDevice = VK_NULL_HANDLE;
VkDevice                 imguiLayer::g_Device = VK_NULL_HANDLE;
uint32_t                 imguiLayer::g_QueueFamily = (uint32_t)-1;
VkQueue                  imguiLayer::g_Queue = VK_NULL_HANDLE;
VkDebugReportCallbackEXT imguiLayer::g_DebugReport = VK_NULL_HANDLE;
VkPipelineCache          imguiLayer::g_PipelineCache = VK_NULL_HANDLE;
VkDescriptorPool         imguiLayer::g_DescriptorPool = VK_NULL_HANDLE;
                         
int                      imguiLayer::g_MinImageCount = 2;
bool                     imguiLayer::g_SwapChainRebuild = false;
ImGui_ImplVulkanH_Window imguiLayer::g_MainWindowData;
...
void imguiLayer::SetupVulkan(const char** extensions, uint32_t extensions_count)
{
    VkResult err;
...
void imguiLayer::glfw_error_callback(int error, const char* description)
{
...
void imguiLayer::onUpdate()
{
    ...
    if (ioHolder->ConfigFlags & ImGuiConfigFlags_ViewportsEnable)
    {
